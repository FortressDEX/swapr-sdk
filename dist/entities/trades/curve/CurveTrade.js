...
class CurveTrade extends trade_1.Trade {
    ...
    static getQuote({ currencyAmountIn, currencyOut, maximumSlippage }, provider) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            provider = provider || (0, utils_4.getProvider)(chainId);
            ...
            // First using address
            // then, using symbol
            const isNativeAssetIn = tokenIn.address.toLowerCase() == ((_b = nativeCurrency.address) === null || _b === void 0 ? void 0 : _b.toLowerCase())
                ? true
            ...
            if (bestPoolAndOutputRes) {
                (0, utils_1.debug)(`Curve::GetQuote | Found best pool from Curve`, bestPoolAndOutputRes);
                routablePools = curvePools.filter((pool) => pool.address.toLowerCase() === bestPoolAndOutputRes.poolAddress.toLowerCase());
                (0, utils_1.debug)(`Curve::GetQuote | Routable pools`, routablePools);
            }
            (0, utils_1.debug)(routablePools);
            ...
            const quoteFromPoolList = yield Promise.all(routablePools.map((pool) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                (0, utils_1.debug)('Curve::GetQuote | Fetching estimated output', {
            ...
            // Map token address to index
            const tokenInIndex = (0, utils_2.getTokenIndex)(pool, tokenIn.address, chainId);
            const tokenOutIndex = (0, utils_2.getTokenIndex)(pool, tokenOut.address, chainId);
            ...
            (0, utils_1.debug)(`Curve::GetQuote | Final pool`, {
