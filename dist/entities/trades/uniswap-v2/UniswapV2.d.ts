...
export declare class UniswapV2Trade extends TradeWithSwapTransaction {
     ...
     */
    static computeTradeExactIn({ currencyAmountIn, currencyOut, maximumSlippage, pairs, maxHops: { maxNumResults, maxHops }, currentPairs, originalAmountIn, bestTrades, }: UniswapV2TradeComputeTradesExactInParams): UniswapV2Trade[];
    /**
     ...
     */
    static computeTradeExactOut({ currencyAmountOut, currencyIn, maximumSlippage, pairs, maxHops: { maxNumResults, maxHops }, currentPairs, originalAmountOut, bestTrades, }: UniswapV2TradeComputeTradesExactOutParams): UniswapV2Trade[];
