...
const utils_2 = require("../../curve/contracts/utils");
 ...
 * @returns
 */
function getAllCommonPairs(currencyA, currencyB, platform = uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR) {
    var _a, _b;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const multicallContract = new contracts_1.Contract(constants_1.MULTICALL2_ADDRESS[chainId], constants_1.MULTICALL2_ABI, (0, utils_2.getProvider)(chainId));
