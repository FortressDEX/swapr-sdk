...
class UniswapV2Trade extends trade_1.TradeWithSwapTransaction {
    ...
    static bestTradeExactIn({ currencyAmountIn, currencyOut, maximumSlippage, maxHops: { maxNumResults = 3, maxHops = 3 } = {}, platform, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const commonPairsBetweenCurrenyInAndOut = yield (0, contracts_2.getAllCommonPairs)(currencyAmountIn.currency, currencyOut, platform);
    ...
    static bestTradeExactOut({ currencyIn, currencyAmountOut, maximumSlippage, maxHops: { maxNumResults = 3, maxHops = 3 } = {}, platform, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // Fetch the commons pairs between A and B
                const commonPairsBetweenCurrenyInAndOut = yield (0, contracts_2.getAllCommonPairs)(currencyIn, currencyAmountOut.currency, platform);
                // Compare and sort all routes from A to B
     ...
     */
    static computeTradeExactIn({ currencyAmountIn, currencyOut, maximumSlippage, pairs, maxHops: { maxNumResults = 3, maxHops = 3 } = {}, 
    // used in recursion.
     ...
     */
    static computeTradeExactOut({ currencyAmountOut, currencyIn, maximumSlippage, pairs, maxHops: { maxNumResults = 3, maxHops = 3 } = {}, 
    // used in recursion.
