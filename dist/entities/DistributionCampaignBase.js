...
const MINIMUM_STAKED_AMOUNT_NATIVE_CURRENCY = {
    [constants_1.ChainId.RINKEBY]: fractions_1.CurrencyAmount.nativeCurrency(ethers_1.utils.parseUnits('0.05', token_1.Token.getNative(constants_1.ChainId.RINKEBY).decimals).toString(), constants_1.ChainId.RINKEBY),
    [constants_1.ChainId.MAINNET]: fractions_1.CurrencyAmount.nativeCurrency(ethers_1.utils.parseUnits('0.1', token_1.Token.getNative(constants_1.ChainId.MAINNET).decimals).toString(), constants_1.ChainId.MAINNET),
    [constants_1.ChainId.XDAI]: fractions_1.CurrencyAmount.nativeCurrency(ethers_1.utils.parseUnits('1000', token_1.Token.getNative(constants_1.ChainId.XDAI).decimals).toString(), constants_1.ChainId.XDAI),
    [constants_1.ChainId.ARBITRUM_ONE]: fractions_1.CurrencyAmount.nativeCurrency(ethers_1.utils.parseUnits('0.1', token_1.Token.getNative(constants_1.ChainId.ARBITRUM_ONE).decimals).toString(), constants_1.ChainId.ARBITRUM_ONE),
    [constants_1.ChainId.ARBITRUM_RINKEBY]: fractions_1.CurrencyAmount.nativeCurrency(ethers_1.utils.parseUnits('0.05', token_1.Token.getNative(constants_1.ChainId.ARBITRUM_RINKEBY).decimals).toString(), constants_1.ChainId.ARBITRUM_RINKEBY)
};
