...
const uniswap_v2_routable_platform_1 = require("./trades/routable-platform/uniswap-v2-routable-platform");
...
let PAIR_ADDRESS_CACHE = {
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR.name]: Object.assign({}, INITIAL_CACHE_STATE),
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SUSHISWAP.name]: Object.assign({}, INITIAL_CACHE_STATE),
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.UNISWAP.name]: Object.assign({}, INITIAL_CACHE_STATE),
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.HONEYSWAP.name]: Object.assign({}, INITIAL_CACHE_STATE),
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.BAOSWAP.name]: Object.assign({}, INITIAL_CACHE_STATE),
    [uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.LEVINSWAP.name]: Object.assign({}, INITIAL_CACHE_STATE),
};
class Pair {
    constructor(tokenAmountA, tokenAmountB, swapFee, protocolFeeDenominator, platform = uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR, liquidityMiningCampaigns = []) {
        ...
        this.platform = platform ? platform : uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR;
    ...
    static getAddress(tokenA, tokenB, platform = uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR) {
        var _a, _b, _c, _d, _e;
    ...
    getOutputAmount(inputAmount) {
        ...
        return [
            outputAmount,
            new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.swapFee, this.protocolFeeDenominator),
        ];
    }
