...
const uniswap_v2_routable_platform_1 = require("./entities/trades/routable-platform/uniswap-v2-routable-platform");
/**
...
class Fetcher {
     ...
     */
    static fetchPairData(tokenA, tokenB, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(tokenA.chainId)), platform = uniswap_v2_routable_platform_1.UniswapV2RoutablePlatform.SWAPR) {
    ...
    static fetchSwapFees(liquidityTokens, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(liquidityTokens[0].chainId))) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const multicall = new contracts_1.Contract(constants_1.MULTICALL_ADDRESS[liquidityTokens[0].chainId], constants_1.MULTICALL_ABI, provider);
            ...
            const result = yield multicall.aggregate(calls.map((call) => [call.address, call.callData]));
    ...
    static fetchAllSwapFees(chainId, swapFeesCache = {}, provider = (0, providers_1.getDefaultProvider)((0, networks_1.getNetwork)(chainId))) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const multicall = new contracts_1.Contract(constants_1.MULTICALL_ADDRESS[chainId], constants_1.MULTICALL_ABI, provider);
